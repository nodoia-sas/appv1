...
const API_BASE_PATH = process.env.API_BASE_PATH || '/transitia/api/v1'

const API_ENVIRONMENTS = {
  local: {
    baseUrl: process.env.API_BASE_URL_LOCAL || 'http://localhost:8010',
    basePath: API_BASE_PATH,
    name: 'Local Development'
  },
  dev: {
    baseUrl: process.env.API_BASE_URL_DEV || 'https://api-dev.transitia.com',
    basePath: API_BASE_PATH,
    name: 'Development'
  },
  staging: {
    baseUrl: process.env.API_BASE_URL_STAGING || 'https://api-staging.transitia.com',
    basePath: API_BASE_PATH,
    name: 'Staging'
  },
  production: {
    baseUrl: process.env.API_BASE_URL_PRODUCTION || 'https://api.transitia.com',
    basePath: API_BASE_PATH,
    name: 'Production'
  }
}
