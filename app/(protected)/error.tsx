 ...
 *
 * This component handles errors that occur in protected routes.
 * Provides context-aware error handling for authenticated sections.
 *
        ...
        <div className="text-center space-y-6 max-w-md mx-auto px-4">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl font-semibold text-foreground">
              Error en sección protegida
            </h1>
            <p className="text-muted-foreground">
              Ha ocurrido un error en esta sección. Verifica tu sesión e intenta
              nuevamente.
            </p>
          </div>
